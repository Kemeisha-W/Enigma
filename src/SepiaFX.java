...
public class SepiaFX implements ImageFX {
	...
	private static final int WIDTH = 200;		// width of the image
	private static final int HEIGHT = 200;		// height of the image
	...
	private Image image;		// image for effect
	...
	public SepiaFX(JPanel p) {
		...
		image = ImageManager.loadImage("Assets/images/trophy.png");
		BufferedImage bImg = ImageManager.loadBufferedImage("Assets/images/trophy.png");
		copyImage = ImageManager.copyImage(bImg);
	...
	public void draw(Graphics2D g2d) {
		g2d.drawImage(copyImage,x,y,WIDTH, HEIGHT, null);
	}
