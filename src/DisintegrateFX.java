...
public class DisintegrateFX implements ImageFX {
	...
	private static final int Y_POS = 250;		// vertical position of the image
	...
	private BufferedImage image;		// image for sprite effect
	...
	public DisintegrateFX(JPanel p, String filename) {
		panel = p;
		...
		image = ImageManager.loadBufferedImage(filename);
